...
export default function LandingPage() {
  ...
  return (
    <div className="h-svh w-full bg-background flex flex-col overflow-hidden select-none touch-none gpu-accelerated relative">
      ...
      {/* Header Section */}
      <header className="shrink-0 z-50 px-6" style={{ paddingTop: 'calc(1rem + env(safe-area-inset-top))' }}>
        <div className="flex justify-between items-center w-full">
          ...
          <div className="flex items-center gap-3">
            <div className="flex gap-1.5 items-center glass px-3 py-2 rounded-full border-none">
              {SLIDES.map((_, i) => (
                <motion.div
                  key={i}
                  animate={{ 
            ...
            <Button 
              size="icon" 
              variant="ghost" 
              className="h-10 w-10 glass rounded-full border-none shadow-sm active:scale-90 transition-all" 
              onClick={toggleTheme}
            >
      ...
      <footer className="shrink-0 w-full glass-thick rounded-t-[3.5rem] shadow-xl pt-6 pb-safe px-8 text-center flex flex-col items-center z-50">
        ...
        <div className="w-full max-w-sm flex flex-col gap-3">
          <AuthModal 
            defaultTab="register"
            trigger={
              <Button className="w-full h-14 rounded-2xl font-black text-sm uppercase tracking-widest bg-primary text-white shadow-xl shadow-primary/20 transition-all border-none">
                Get Started
          ...
          <AuthModal 
            defaultTab="login"
            trigger={
              <button className="flex items-center justify-center gap-1.5 opacity-60 hover:opacity-100 transition-opacity pb-2">
