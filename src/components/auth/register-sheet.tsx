          ...
          {!showVerifyPrompt ? (
            ...
            <div className="flex flex-col items-center text-center py-6">
              ...
              <div className="w-full space-y-3">
                <Button 
                  variant="outline" 
                  className="w-full h-16 rounded-2xl border-none glass font-black text-[10px] uppercase tracking-widest active:scale-[0.97] transition-all"
                ...
                <Button 
                  className="w-full h-16 rounded-2xl font-black text-[10px] uppercase tracking-widest bg-foreground text-background active:scale-[0.97] transition-all"
