        ...
        <div className="max-w-md mx-auto flex flex-col px-6 pb-12">
          {!showVerifyPrompt ? (
            <div>
              <div className="flex flex-col items-center mb-6 text-center">
                ...
                <SheetHeader className="space-y-1">
                  <SheetTitle className="text-xl font-black tracking-tighter">Create Identity</SheetTitle>
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="mt-2 flex items-start gap-3 p-3 bg-primary/[0.03] rounded-2xl border border-primary/10 mx-1">
                    ...
                    <label htmlFor="terms" className="text-[9px] font-bold leading-relaxed text-foreground/60">
                      I agree to the <span className="text-primary font-black underline underline-offset-4">Quvora Privacy Terms</span>.
                    </label>
                  </div>
                </div>
            ...
            <div className="flex flex-col items-center text-center py-6">
              <div className="w-16 h-16 rounded-[1.6rem] bg-primary/10 flex items-center justify-center mb-5 shadow-inner">
              ...
              <SheetHeader className="mb-6">
                ...
                <SheetDescription className="text-muted-foreground text-[10px] font-bold leading-relaxed px-4 uppercase tracking-tight">
                  Activation link sent to <span className="text-foreground font-black lowercase">{email}</span>. Click it to verify.
                </SheetDescription>
              </SheetHeader>
